                    ...
                    <div class="row reorder-xs align-items-center">
                      <div class="col-xl-7 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="header__title">
                          ...
                          <p>Dashboard <i class="fa fa-angle-right"></i> Packages <i class="fa fa-angle-right"></i> Update</p>
                        </div>
                      </div>
                    ...
                    <div class="col-xl-10">
                      <div class="top-banner-wrap">
                        <div class="common-form">
                          <form id="form1" action="{{ route('admin-package-update',$package->id) }}" method="POST" enctype="multipart/form-data">
                              {{csrf_field()}}
                            <div class="form-group row">
                              <label for="title" class="col-sm-4 col-form-label">Title * <span>(In Any Language)</span></label>
                              <div class="col-sm-7">
                                <input type="text" class="form-control" name="title" id="title" placeholder="Title" value="{{ $package->title }}" required>
                              </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input class="form-control" id="name" name="name" placeholder="Sub Title" type="text" value="{{ $package->name }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <div class="logo"><img id="adminimg" src="{{ $package->photo ? asset('assets/images/packages/'.$package->photo):asset('assets/images/noimage.png') }}" alt="Image"></div>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                <textarea class="form-control nic-edit" cols="30" rows="5" name="description" id="description">{{ $package->description }}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input class="form-control" id="start_date" name="start_date" placeholder="Departure Date" required="required" type="text" value="{{ $package->start_date }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input class="form-control" id="return_date" name="return_date" placeholder="Return Date" required="required" type="text" value="{{ $package->return_date }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input class="form-control" id="location" name="location" placeholder="Tour Location" required="required" type="text" value="{{ $package->location }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input class="form-control" id="cost_adult" name="cost_adult" placeholder="Adult Cost" type="number" step=".01" value="{{round($package->cost_adult * $sign->value , 2)}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input class="form-control" id="cost_child" name="cost_child" placeholder="Child Cost" type="number" step=".01" value="{{round($package->cost_child * $sign->value , 2)}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label" for="cost_previous">Previous Cost<span>(Optional)</span></label>
                                <div class="col-sm-7">
                                    <input class="form-control" id="cost_previous" name="cost_previous" placeholder="Previous Cost" type="text" value="{{round($package->cost_previous * $sign->value , 2)}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input class="form-control" id="highlight_discount" name="highlight_discount" placeholder="Discount" type="text" value="{{ $package->highlight_discount }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input class="form-control mytags" id="highlights" name="highlights" placeholder="Package Highlights" type="text" value="{{ $package->highlights }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input class="form-control mytags" id="includes" name="includes" placeholder="Package Includes" type="text" value="{{ $package->includes }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input class="form-control mytags" id="excludes" name="excludes" placeholder="Package Excludes" type="text" value="{{ $package->excludes }}">
                                </div>
                            </div>
                            <hr style="margin-top: 20px; margin-bottom: 20px;">
                                ...
                                <div class="col-sm-12">
                                  ...
                                  <div class="featured__box">
                                    ...
                                    <div class="form-group  row align-items-center">
                                        ...
                                        <input type="text" class="form-control" id="offer_title" name="offer_title[]" placeholder="Title" value="{{ $title[$key] }}">
                                      </div>
                                    </div> 
                                    <div class="form-group  row align-items-center">
                                        <label class="col-sm-2 col-form-label" for="offer_day">Day *</label>
                                        <div class="col-sm-10 add_width">
                                        <input type="text" class="form-control" id="offer_day" name="offer_day[]" placeholder="Day" value="{{ $day[$key] }}">
                                      </div>
                                    </div> 
                                    <div class="form-group  row align-items-center">
                                        <label class="col-sm-2 col-form-label" for="offer_subtitle">Sub Title *</label>
                                        <div class="col-sm-10 add_width">
                                        <input type="text" class="form-control" id="offer_subtitle" name="offer_subtitle[]" placeholder="Sub Title" value="{{ $subtitle[$key] }}">
                                      </div>
                                    </div> 
                                    <div class="form-group  row align-items-center">
                                        <label class="col-sm-2 col-form-label" for="offer_tags">Tags *<span>Separated By Comma(,)</span></label>
                                        <div class="col-sm-10 add_width">
                                        <input type="text" class="form-control" id="offer_tags" name="offer_tags[]" placeholder="Tags" value="{{ $tags[$key] }}">
                                      </div>
                                    </div> 
                                    <div class="form-group  row align-items-center">
                                        <label class="col-sm-2 col-form-label" for="offer_details">Description *</label>
                                        <div class="col-sm-10 add_width">
                                          <textarea class="form-control" cols="30" rows="5" id="offer_details" name="offer_details[]" placeholder="Description"> {{ $details[$key] }}</textarea>
                                      </div>
                                    </div> 
