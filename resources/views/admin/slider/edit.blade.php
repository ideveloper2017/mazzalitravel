                      ...
                      <div class="col-xl-7 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="header__title">
                          <div class="header__btn d-flex">
                            <h3>Update Image</h3>
                            <a href="{{ route('admin-sl-index') }}" class="add-btn back"><i class="fas fa-arrow-left"></i> Back</a>
                          </div>
                          <p>Dashboard <i class="fa fa-angle-right"></i> Home Page Settings <i class="fa fa-angle-right"></i> About Area Galleries <i class="fa fa-angle-right"></i> Update</p>
                        </div>
                      </div>
                    ...
                    <div class="col-xl-10">
                      <div class="top-banner-wrap">
                        <div class="common-form">
                          <form action="{{route('admin-sl-edit',$data->id)}}" method="POST" enctype="multipart/form-data">
                              {{csrf_field()}}

                            <div class="form-group row">
                              <label for="adminimg" class="col-sm-4 col-form-label">Current Image *</label>
                              <div class="col-sm-7">
                                <div class="logo"><img id="adminimg" src="{{ $data->photo ? asset('assets/images/sliders/'.$data->photo):asset('assets/images/noimage.png') }}" alt="Image"></div>
                              </div>
                            </div>
                            <div class="form-group row">
