                    ...
                    <div class="row reorder-xs align-items-center">
                      <div class="col-xl-7 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="header__title">
                          ...
                          <p>Dashboard <i class="fa fa-angle-right"></i> Resumes <i class="fa fa-angle-right"></i> Add</p>
                        </div>
                      </div>
                    ...
                    <div class="col-xl-10">
                      <div class="top-banner-wrap">
                        <div class="common-form">
                          <form action="{{route('admin-resume-create')}}" method="POST" enctype="multipart/form-data">
                              {{csrf_field()}}
