                    ...
                    <div class="row reorder-xs align-items-center">
                      <div class="col-xl-7 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="header__title">
                          ...
                          <p>Dashboard <i class="fa fa-angle-right"></i> Manage Blog <i class="fa fa-angle-right"></i> Categories <i class="fa fa-angle-right"></i> Add</p>
                        </div>
                      </div>
                        ...
                        <div class="common-form">
                          <form action="{{route('admin-cblog-create')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                              <label for="name" class="col-sm-4 col-form-label">Name * <span>(In Any Language)</span></label>
                              <div class="col-sm-7">
