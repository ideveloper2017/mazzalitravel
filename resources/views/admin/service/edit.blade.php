                      ...
                      <div class="col-xl-7 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="header__title">
                          <div class="header__btn d-flex">
                            ...
                            <a href="{{ route('admin-service-index') }}" class="add-btn back"><i class="fas fa-arrow-left"></i> Back</a>
                          </div>
                          <p>Dashboard <i class="fa fa-angle-right"></i> Home Page Settings <i class="fa fa-angle-right"></i> Services <i class="fa fa-angle-right"></i> Update</p>
                        </div>
                      </div>
                    ...
                    <div class="col-xl-10">
                      <div class="top-banner-wrap">
                        <div class="common-form">
                          <form action="{{route('admin-service-update',$ad->id)}}" method="POST" enctype="multipart/form-data">
                              {{csrf_field()}}
                            <div class="form-group row">
                              <label for="title" class="col-sm-4 col-form-label">Title * <span>(In Any Language)</span></label>
                              <div class="col-sm-7">
                                <input type="text" class="form-control" name="title" id="title" placeholder="Title" value="{{$ad->title}}" required>
                              </div>
                            </div>
                            <div class="form-group row">
                              <label for="adminimg" class="col-sm-4 col-form-label">Current Image *</label>
                              <div class="col-sm-7">
                                <div class="logo"><img id="adminimg" src="{{ $ad->photo ? asset('assets/images/services/'.$ad->photo):asset('assets/images/noimage.png')}}" alt="Image"></div>
                              </div>
                            </div>
                            <div class="form-group row">
