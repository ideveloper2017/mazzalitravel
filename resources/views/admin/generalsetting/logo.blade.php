                    ...
                    <div class="row reorder-xs align-items-center">
                      <div class="col-xl-7 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="header__title">
                          ...
                          <p>Dashboard <i class="fa fa-angle-right"></i> Generel Settings <i class="fa fa-angle-right"></i> Logo</p>
                        </div>
                      </div>
                        ...
                        <form class="form-horizontal" action="{{ route('admin-gs-logoup') }}" method="POST" enctype="multipart/form-data">
                          {{csrf_field()}}   
                           ...
                           <div class="form-group row">
                              <label for="setup_logo" class="col-sm-5 col-form-label">Current Logo *</label>
                                 <div class="col-sm-7 logo">
                                    <img src="{{ $data->logo ? asset('assets/images/'.$data->logo):asset('assets/images/noimage.png')}}" alt="Image">
                                 </div>
                           </div>
                           <div class="form-group row">
                              <label for="logo" class="col-sm-5 col-form-label">Setup New Logo *</label>
                                 <div class="col-sm-7">
