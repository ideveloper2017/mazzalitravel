                    ...
                    <div class="row reorder-xs align-items-center">
                      <div class="col-xl-7 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="header__title">
                          ...
                          <p>Dashboard <i class="fa fa-angle-right"></i> Generel Settings <i class="fa fa-angle-right"></i> Background Image</p>
                        </div>
                      </div>
                           ...
                           <div class="form-group row">
                              <label for="setup_logo" class="col-sm-5 col-form-label">Current Background Image *</label>
                                 <div class="col-sm-7 logo">
                                    <img src="{{ $data->bgimg ? asset('assets/images/'.$data->bgimg):asset('assets/images/noimage.png')}}" alt="Image">
                                 </div>
                           </div>
                           <div class="form-group row">
                              <label for="bgimg" class="col-sm-5 col-form-label">Setup New Background Image *</label>
                                 <div class="col-sm-7">
                                    <input name="bgimg" id="bgimg"  type="file">
                                 </div>
                           </div>
