                    ...
                    <div class="row reorder-xs align-items-center">
                      <div class="col-xl-7 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="header__title">
                          ...
                          <p>Dashboard <i class="fa fa-angle-right"></i> Manage Blog <i class="fa fa-angle-right"></i> Posts <i class="fa fa-angle-right"></i> Add</p>
                        </div>
                      </div>
                        ...
                        <div class="common-form">
                          <form action="{{route('admin-blog-create')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-7">
                                <div class="top-banner-btn text-center">
                                  ...
                                  <button type="button" class="form-control uploadTrigger"><i class="fas fa-download"></i> Add Blog Image</button>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-7">
                                <textarea name="details" id="details" cols="30" rows="5" placeholder="Details" class="form-control nic-edit"></textarea>
                              </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                              <div class="col-sm-7 offset-sm-4">
                                <input type="checkbox" class="checkclick" name="secheck" id="seo">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-7">
                                <input id="meta_tags" name="meta_tag[]" type="text" value="" class="form-control mytags">
                              </div>
                            </div>
                              <div class="form-group row">
                              <label for="meta_description" class="col-sm-4 col-form-label">Meta Description *</label>
                              <div class="col-sm-7">
                                <textarea name="meta_description" id="meta_description" cols="30" rows="5" class="form-control" placeholder="Meta Description"></textarea>
                              </div>
                            </div>
                            </div>
                            <div class="form-group row">
                              ...
                              <div class="col-sm-7">
                                <input id="tags" name="tags[]" type="text" value="" class="form-control mytags">
                              </div>
                            </div>
