                    ...
                    <div class="row reorder-xs align-items-center">
                      <div class="col-xl-7 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="header__title">
                          ...
                          <p>Dashboard <i class="fa fa-angle-right"></i> Menu Page Settings <i class="fa fa-angle-right"></i> FAQ Page <i class="fa fa-angle-right"></i> Update</p>
                        </div>
                      </div>
                    ...
                    <div class="col-xl-10">
                      <div class="top-banner-wrap">
                        <div class="common-form">
                          <form action="{{ route('admin-fq-update',$faq->id) }}" method="POST">
                              {{csrf_field()}}
                            <div class="form-group row">
                              <label for="title" class="col-sm-4 col-form-label">Title * <span>(In Any Language)</span></label>
                              <div class="col-sm-7">
                                <input type="text" class="form-control" name="title" id="title" placeholder="Title" value="{{$faq->title}}" required>
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-7">
                                <textarea name="text" id="details" cols="30" rows="5" placeholder="Details" class="form-control nic-edit">{{ $faq->text }}</textarea>
                              </div>
                            </div>
