                    ...
                    <div class="row reorder-xs align-items-center">
                      <div class="col-xl-7 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="header__title">
                          ...
                          <p>Dashboard <i class="fa fa-angle-right"></i> Department <i class="fa fa-angle-right"></i> Add</p>
                        </div>
                      </div>
                        ...
                        <div class="common-form">
                          <form action="{{route('admin-cat-create')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-7">
                                <input type="text" class="form-control" name="cat_name" id="cat_name" placeholder="Name" required>
                              </div>
                            </div>
                            <div class="form-group row">
                              <label for="cat_slug" class="col-sm-4 col-form-label">Slug * <span>(In English)</span></label>
                              <div class="col-sm-7">
                                <input type="text" class="form-control" name="cat_slug" id="cat_slug" placeholder="Slug" required>
                              </div>
                            </div>
